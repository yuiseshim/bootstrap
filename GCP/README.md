...
## VMインスタンス: インスタンスの作成
```
gcloud compute instances create l4-g2 \
    --project=mycomputer-465723 \
    --zone=asia-northeast1-b \
    ...
    --tags=ssh-only \
    --create-disk=auto-delete=yes,boot=yes,device-name=l4-g2,disk-resource-policy=projects/mycomputer-465723/regions/asia-northeast1/resourcePolicies/default-schedule-1,image=projects/ubuntu-os-cloud/global/images/ubuntu-2404-noble-amd64-v20260517,mode=rw,size=510,type=pd-balanced \
